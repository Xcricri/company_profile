    ...
    <flux:sidebar sticky collapsible="mobile"
        ...
        <flux:sidebar.nav>
            <flux:sidebar.group :heading="__('Platform')" class="grid">
                ...
                <flux:sidebar.item icon="briefcase" :href="route('services.index')"
                ...
                <flux:sidebar.item icon="phone" :href="route('contacts.index')"
                    :current="request()->routeIs('contacts.index')" wire:navigate>
                    {{ __('Contacts') }}
                </flux:sidebar.item>
            </flux:sidebar.group>
        </flux:sidebar.nav>
